...
# 👋 Welcome, I am Akash
Researcher at TU Delft in <a href="https://qutech.nl/lab/feld-group/"><b>Sebastian Feld group</b></a>. I am an [ex postdoc with Sabrina Maniscalco](https://researchportal.helsinki.fi/en/persons/akash-kundu/) at University of Helsinki. I completed my [PhD with Jarek Miszczak @ IITiS, Poland](https://miszczak.eu/projects/qprogmods/). [My PhD Thesis](https://arxiv.org/abs/2402.13754). For last 5 years I'm working in the intersection of classical machine learning and quantum computing, leveraging near-term quantum hardware and beyond with advanced RL methods. My expertise is in Quantum Architecture Search. Excluding reading my hobbies are: *Biking*, watching *Summoning Salt*, listening to *Summer Salt*, stumbling upon *Untitled YouTube Videos*, *Goppo Mir er Thek*, and *Advaita Vedanta*.
...
">
  <div style="display: flex; align-items: flex-start; gap: 2.5rem; flex-wrap: wrap;">
    <div style="flex: 0 0 390px; max-width: 390px; min-width: 220px;">
      <a href="https://openreview.net/forum?id=0okFLZvtKs">
  ...
  <div style="display: flex; align-items: flex-start; gap: 2.5rem; flex-wrap: wrap;">
    <div style="flex: 0 0 390px; max-width: 390px; min-width: 220px;">
      <a href="https://arxiv.org/abs/2507.12189">
        <img src="./img/benchRL-QAS.png" alt="benchRL-QAS" style="width: 200%; max-width: 390px; border-radius: 20px; box-shadow: 0 4px 10px rgba(12, 1, 1, 0.08); display: block;">
      </a>
    </div>
    <div style="flex: 2 1 340px; min-width: 260px; margin-left: 2rem; font-size: 14px;">
